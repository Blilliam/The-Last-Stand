...
public class SwordWeapon extends Weapon {
	...
	public SwordWeapon(GameObject gameObj) {
		...
		// Sword has a wide crescent AoE, so damage is moderate but it hits multiple
		// enemies.
	...
	protected void fireProjectile() {
		...
		if (target != null) {
			...
			gameObj.addProjectiles(new SwordProjectile(gameObj, this, direction, gameObj.getPlayer().getX(),
