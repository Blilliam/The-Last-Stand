...
public class SwordProjectile extends WeaponEntity {
    ...
    private void syncHitboxToPlayer() {
        // 1. Center hitbox on the player's center
        ...
        // 2. Compute the exact local crescent math matching your swing progress
        ...
        // Base crescent centered around origin (0,0)
        ...
        // 3. Transform local crescent to the actual world coordinates and rotate it
        AffineTransform tx = new AffineTransform();
        tx.translate(pCenterX, pCenterY); // Move to player center in world-space
        tx.rotate(this.angle);            // Rotate to aiming direction

        // This is your final, pixel-perfect physical hitbox
        this.hitBox = tx.createTransformedShape(crescentLocal);
    }
