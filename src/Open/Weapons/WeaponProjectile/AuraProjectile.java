...
public class AuraProjectile extends WeaponEntity {
	...
	public void update() {
		...
		for (Enemy e : new ArrayList<>(gameObj.getEnemies())) {
	...
	public void draw(Graphics2D g) {
		...
		int screenX = (int) position.getX() - gameObj.getCameraX() + width/2 - gameObj.getPlayer().getWidth()/2;
		int screenY = (int) position.getY() - gameObj.getCameraY() + height/2 - gameObj.getPlayer().getHeight()/2;
