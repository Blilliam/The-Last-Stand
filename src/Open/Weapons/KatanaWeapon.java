...
public class KatanaWeapon extends Weapon {
    public KatanaWeapon(GameObject gameObj) {
        ...
        // Katana teleports a strike directly onto the target — zero positioning skill required.
        // Compensated by: lower base damage than Sword, longer cooldown, very high crit rate
        // so the identity is "bursty crit assassin" rather than just a free-hit machine.
