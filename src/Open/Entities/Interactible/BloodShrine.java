...
public class BloodShrine extends Interactible {
	...
	public BloodShrine(GameObject gameObj, int x, int y) {
		...
		width = 100;
		height = 100;
		this.setHitBox(new Rectangle2D.Double(this.x + width/4, this.y + height/4, this.width / 2, this.height / 2));
	...
	public int getGold() {
		...
		case 0:
			return (int) (Chest.BASE_COST * getCostMultiplier());
		case 1:
			return (int) (Chest.BASE_COST * getCostMultiplier() * 1.5);
		case 2:
			return (int) (Chest.BASE_COST * getCostMultiplier() * 2);
		default:
			return 0;
		}
	}
