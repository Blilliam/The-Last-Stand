 ...
 * Teleporter (updated)
 *
 * Spawns a different boss depending on the current map stage:
 *   Stage 1 → BossEnemy    (The Lich King)
 *   Stage 2 → FireDemonBoss (Ignis, the Eternal Flame)
 *   Stage 3 → VoidLichBoss  (Nyarathul, the Void Eternal — final boss)
 *
 * The player must stand near it and press E to activate.
 * After the boss dies, a Portal is spawned here so the player can advance.
 */
