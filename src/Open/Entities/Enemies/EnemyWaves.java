...
public class EnemyWaves {
    ...
    public EnemyWaves(GameObject gameObj) {
        ...
        this.credits = 10; // Start with more credits for a faster early game
    ...
    public double getDifficultyMult() {
        return (1.0 + (tickCounter / 1800.0) * 0.1)  * gameObj.getMap().getStage() * (gameObj.getDifficulty().ordinal() * 0.5 + 1.0); // Faster scaling with stage and difficulty
    }
