...
public class Upgrades {
	...
	private final String[] bookPool = { "EXP Book", "Size Book", "Quantity Over Quality Book", "Projectile Speed Book",
	...
	private Color getSlotColor(int i) {
		if (boxRarities[i] == null) {
			...
			return boxIsBook[i] ? new Color(65, 35, 100) : new Color(100, 100, 100);
		}
