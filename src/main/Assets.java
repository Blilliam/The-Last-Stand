...
public class Assets {
	...
	private static int treeTileWidth = 5;
	private static int treeTileHeight = 5;
...
//	public static BufferedImage fireWand;
	...
	public static BufferedImage BloodShrine;
	...
	public static BufferedImage UncommonKevinIcon;
	public static BufferedImage UncommonGoldenShieldIcon;

	public static BufferedImage RareChunkyRingIcon;
	public static BufferedImage RareCreditCardIcon;
	public static BufferedImage RareMirrorIcon;
	public static BufferedImage RareDemonSoulIcon;

	public static BufferedImage LegendaryMagenetIcon;
	public static BufferedImage LegendaryAnvilIcon;
	public static BufferedImage LegendaryBigForkIcon;
	public static BufferedImage LegendaryBigHammerIcon;
	...
	public static void load() {
		...
		UncommonKevinIcon = loadImage("Images/Artifacts/Uncommon/Item_Kevin.png");
		UncommonGoldenShieldIcon = loadImage("Images/Artifacts/Uncommon/Item_Golden_Shield.png");

		RareChunkyRingIcon = loadImage("Images/Artifacts/Rare/Item_Beefy_Ring.png");
		RareCreditCardIcon = loadImage("Images/Artifacts/Rare/Item_Credit_Card_Green.png");
		RareMirrorIcon = loadImage("Images/Artifacts/Rare/Item_Mirror.png");
		RareDemonSoulIcon = loadImage("Images/Artifacts/Rare/Item_Demonic_Soul.png");

		LegendaryMagenetIcon = loadImage("Images/Artifacts/Legendary/Item_Sucky_Magnet.png");
		LegendaryAnvilIcon = loadImage("Images/Artifacts/Legendary/Item_Anvil.png");
		LegendaryBigForkIcon = loadImage("Images/Artifacts/Legendary/Item_Giant_Fork.png");
		LegendaryBigHammerIcon = loadImage("Images/Artifacts/Legendary/Item_Big_Bonk.png");
		// BACKGROUND
		background1 = loadImage("Images/Map/Background1.png");
		background2 = loadImage("Images/Map/Background2.png");
		background3 = loadImage("Images/Map/Background2.png");
		
		menuBackground = loadImage("Images/background.png");
		// INTERACTIBLES
		BloodShrine = loadImage("Images/Interactibles/BloodShrine.png");
		Teleporter = loadImage("Images/Interactibles/Teleporter.png");
		...
		coin = splitSpriteSheet(loadImage("Images/Coins/MonedaD.png"), 16, 16);
		...
		tree = splitSpriteSheet(loadImage("Images/Map/TX Plant.png"), tileSize * treeTileWidth,
				tileSize * treeTileHeight)[0];
	}
	...
	public static BufferedImage[] loadGifFrames(String path) {
		...
		try (ImageInputStream iis = ImageIO.createImageInputStream(file)) {
			...
			for (int i = 0; i < frameCount; i++) {
				...
				BufferedImage copy = new BufferedImage(master.getWidth(), master.getHeight(),
	...
	public static BufferedImage[] splitSpriteSheet(BufferedImage sheet, int frameWidth, int frameHeight) {
		...
		for (int x = 0; x < cols; x++) {
			...
			if (x * frameWidth + frameWidth > sheet.getWidth())
				break;
			if (frameHeight > sheet.getHeight())
				break;

			BufferedImage frame = sheet.getSubimage(x * frameWidth, 0, frameWidth, frameHeight);
