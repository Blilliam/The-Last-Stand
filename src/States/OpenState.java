...
public class OpenState extends BaseState {
	...
	public void draw(Graphics2D g2) {
		...
		gameObj.getEnemies().sort(Comparator.comparingDouble(Renderable::getSort));
		
		entities.addAll(0, gameObj.getEnemies());
		
		entities.add(gameObj.getPlayer());
		
		gameObj.getInteractibles().sort(Comparator.comparingDouble(Renderable::getSort));
		
		entities.addAll(0, gameObj.getInteractibles());
